...
public class ExtentReports1 {
    ...
    //ExtentHtmlReporter ==>>Raporlari yapilandirmaya(confguration) yardimci olur. ve HTML raporalini create eder.
    //ExtentTest==>>Aciklama(logs) eklemek icin,test adimalrini belirlemek icin kullanilir.
    ...
    @BeforeTest
    public  void setup(){
        //Reportari baslatalim ve konumunu ayarlayalim.
        ...
        //daha fazla aciklama ekleyebilriz.
        extentReports.setSystemInfo("Automation engineer","Aziz");
