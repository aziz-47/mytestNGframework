...
public class ReadExcel {
    ...
    public void readExcelFile() throws IOException {
        ...
        String path = "C:\\Users\\Dell\\Downloads\\ULKELER.xlsx";
        //Dosyayi(file) acalim
        ...
        System.out.println("7 SATIR, 2. CELL : "+ sheet.getRow(7).getCell(1));
        System.out.println("2.ROW, 1. CELL : "+ sheet.getRow(2).getCell(1));
        System.out.println("4. ROW TUM CELL: "+ sheet.getRow(4).getCell(2));
